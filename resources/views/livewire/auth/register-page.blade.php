    ...
    <div class="flex h-full items-center">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <form wire:submit.prevent='save'>
                ...
                <button type="submit" class="btn-click font-bold w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm rounded-lg border border-transparent bg-digirest text-black hover:bg-digirestDark disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Registrarse</button>
                </div>
            </form>
            <!-- End Form -->
            </div>
